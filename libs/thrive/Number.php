...
class Thrive_Number extends fNumber
{
	...
	{
		if ($this->base == $toBase) { return $this; }
...
*/
	...
	public function format()
	{
		...
		else
		{
			...
			$formatted = ltrim($this->value, '+-');
			if (strlen($formatted) < 5) { return $formatted; }
			$short = strlen($formatted) % 4;
			...
			$formatted = str_repeat('0', $short) . $this->value;
			$formatted = trim(chunk_split($formatted, 4, ' '));
		}
